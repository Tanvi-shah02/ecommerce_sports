...
<div class="ur-frontend-form login" id="ur-frontend-form">
     <div class="card card-lost-password-wrap shadow-lg border-0">
                    <div class="card-body p-5">
	<form method="post" class="user-registration-ResetPassword lost_reset_password">
		<div class="ur-form-row">
			<div class="ur-form-grid">
                <h5>
                    <?php echo esc_html( apply_filters( 'user_registration_lost_password_message', esc_html__( 'Lost your password? ', 'user-registration' ) ) ); ?>
                </h5>
				<p><?php echo esc_html( apply_filters( 'user_registration_lost_password_message', esc_html__( 'Please enter your username or email address. You will receive a link to create a new password via email.', 'user-registration' ) ) ); ?></p>
